...
class analogyExtr(coOccurrences: Map[String, Map[String, Int]], pipelineNER: StanfordCoreNLP, pipelineSplit: StanfordCoreNLP,  var vectorDoc1: Map[String, Int], var lengthFirstWordVector: Double) {
